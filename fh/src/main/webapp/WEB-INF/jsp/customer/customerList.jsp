        ...
        <form action="" method="post" name="Form" id="Form">
          ...
          <table id="table_report" class="table table-striped table-bordered table-hover">
            ...
            <tr>
              ...
              <th class="center">淘宝会员号</th>
              <th class="center">退货日期</th>
              <th class="center">手机号</th>
              <th class="center">退货快递</th>
                  ...
                  <c:forEach items="${customerList}" var="customer" varStatus="vs">
                    <tr>
                      <td class='center' style="width: 30px;">
                        <label><input type='checkbox' name='ids' value="${customer.customerId}" /><span class="lbl"></span></label>
                      </td>
                      <td class='center'>${customer.tbId}</td>
                      <td class='center'>${customer.backDate}</td>
                      <td class='center'>${customer.phoneNo}</td>
                      <td class='center'>${customer.backExpress }</td>
                      <td style="width: 60px;">
